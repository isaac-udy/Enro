package dev.enro3.processor.generator
...
import dev.enro3.processor.domain.DestinationReference
...
object NavigationDestinationGenerator {
    ...
    fun generate(
        ...
        if (destination.keyIsLegacy) { return }

        val typeSpec = TypeSpec.classBuilder(destination.bindingName)
            .addModifiers(KModifier.PUBLIC)
            .addSuperinterface(
                ClassName("dev.enro3.controller", "NavigationModuleAction")
            )
            .addAnnotation(
            ...
            .addFunction(
                FunSpec.builder("invoke")
                    .receiver(ClassName("dev.enro3.controller", "NavigationModule.BuilderScope"))
        ...
        FileSpec
            ...
            .addImport("dev.enro3.controller", "NavigationModule")
            .addImport("dev.enro3.ui", "navigationDestination")
            .apply {
                when {
                    destination.isActivity -> addImport("dev.enro3.ui.destinations", "activityDestination")
                    destination.isFragment -> addImport("dev.enro3.ui.destinations", "fragmentDestination")
                }
            }
            .build()
            .writeTo(
