...
internal constructor(
    public val key: T,
    public val instruction: NavigationInstructionOpen,
...
public fun <R: Any, Key: NavigationKey.SupportsPresent.WithResult<R>> activityResultDestination(
...
): NavigationDestinationProvider<Key> = syntheticDestination {
    ...
    val pendingResult = instruction.metadata.get(PendingActivityResultKey)
...
@PublishedApi
internal object PendingActivityResultKey: dev.enro.NavigationKey.MetadataKey<ActivityResult?>(default = null)

@Parcelize
internal class ActivityResultDestination(
    @TypeParceler<NavigationInstructionOpen, NavigationInstruction.Parceler> val wrapped: NavigationInstructionOpen,
    val intent: Intent,
        ...
        navigation.execute(
            NavigationOperation.Open(
                navigation.key.wrapped.apply {
                    metadata.set(PendingActivityResultKey, result)
                }
            )
