...
class InstallNavigationControllerTransformer(
    ...
    private val symbols: EnroSymbols,
    ...
    override fun visitCall(expression: IrCall): IrExpression {
        ...
        if (callee.symbol != symbols.installNavigationController) return expression
        val target = expression.typeArguments[0]
            ?: error("No type argument found for installNavigationController")
        ...
        return pluginContext.createIrBuilder(expression.symbol).irReturnableBlock(
            ...
            val createControllerCall = irCall(symbols.internalCreateEnroController).apply {
                ...
                val bindFunctions = symbols.bindFunctions
                    ...
                    irLambda(
                        ...
                        content = { lambda ->
                            ...
                            bindFunctions.forEach { bindFunction ->
                                ...
                                val bindMethod = bindingObjectType.functionByName("bind")
