...
public inline fun <reified KeyType : NavigationKey, reified ActivityType : ComponentActivity> createActivityNavigationBinding(
...
public inline fun <reified KeyType : NavigationKey, reified DestinationType : ComponentActivity> NavigationModuleScope.activityDestination(
    ...
    binding(createActivityNavigationBinding<KeyType, DestinationType>(keySerializer))
}
