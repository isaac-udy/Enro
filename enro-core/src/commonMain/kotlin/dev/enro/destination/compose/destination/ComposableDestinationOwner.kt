...
internal class ComposableDestinationOwner(
    ...
    private val savedInstanceState: SavedState?,
) : ViewModel(),
    LifecycleOwner,
    ViewModelStoreOwner,
    ...
    private val weakParentContainerReference: EnroWeakReference<NavigationContainer> = EnroWeakReference(parentContainer)
    ...
    private val weakDestinationReference: EnroWeakReference<ComposableDestination> = EnroWeakReference(destination)
    internal val destination get() = weakDestinationReference.get() ?: _destination!!

    private val lifecycleRegistry = LifecycleRegistry(this)

    private val savedStateRegistryOwner = ComposableDestinationSavedStateRegistryOwner(
        owner = this,
...
//        _destination = null
    ...
    private fun ProvideCompositionLocals(
        ...
        CompositionLocalProvider(
            ...
            EnroLocalSavedStateRegistryOwner provides this@ComposableDestinationOwner,
