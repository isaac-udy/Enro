...
internal class OnNavigationContextCreatedImpl(
    ...
    override operator fun invoke(
        ...
        if (context is dev.enro.activity.ActivityContext) {
        ...
        val defaultKey = config?.properties?.defaultKey
