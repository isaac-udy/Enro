package dev.enro.compose.preview
...
internal class PreviewNavigationHandle(
    ...
    override val dependencyScope: EnroDependencyScope = object : EnroDependencyScope {
        override val container = EnroDependencyContainer(
            parentScope = null,
            registration = {}
        )
    }
