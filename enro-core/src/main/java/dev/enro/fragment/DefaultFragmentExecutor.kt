...
private fun openFragmentAsActivity(
    ...
    val executeOpenInstruction = fromContext.controller.dependencyScope.get<ExecuteOpenInstruction>()
    val navigationHostFactory = fromContext.controller.dependencyScope.get<NavigationHostFactory>()

    executeOpenInstruction.invoke(
        fromContext,
        navigationHostFactory.createHostFor<Activity>(
